...
public class ProcesadorImagen {
	...
	public static void main(String[] args) {
		ServicioImagen nodo = new ServicioImagen();
		int numIterations = 2;
		Random r = new Random();
...
//			int angle = r.nextInt(361);
			...
			nodo.rotarImagen("C:/Users/jagn1/git/RotacionImagenes/RotacionImagen/img/kamino.png", angle);
		}
